...
for line in sys.stdin:
    ...
    ref_allele_ratio = float(ref_allele_ratio)
    if (counts[hap1_allele] + counts[hap2_allele] >= th_tot and
        counts[hap1_allele] >= th_each and
        counts[hap2_allele] >= th_each and
        0.25 <= ref_allele_ratio <= 0.75):
