...
##
    ...
    for pv in pvs:
        ...
        print("{}\t{}\t{}\t{}".format(pv, Nact, mean_Nsims, FDR))
...
if bestFDR != None and bestPV != None:
    print("Target %f FDR %f pv %f" % (target, bestFDR, bestPV))
else:
    ...
    print("WARNING " + sys.argv[0] + ": couldn't calculate pvalue threshold: no snvs in input or none with small enough p-value (?). will set p value threshold to 0 - no snvs will be reported after filtering", file=sys.stderr)
