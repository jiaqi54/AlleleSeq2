...
JAVA                             := /vast/palmer/apps/avx2/software/Java/11.0.16/bin/java
JAVA_MEM                         := 80g
...
$(PREFIX)_raw_counts.tsv: $(PREFIX)_hap1_uniqreads.mpileup $(PREFIX)_hap2_uniqreads.mpileup
	...
	$(PGENOME_DIR)/$(VCF_SAMPLE_ID)_hetSNVs_hap1_correct.bed $(PGENOME_DIR)/$(VCF_SAMPLE_ID)_hetSNVs_hap2_correct.bed \
...
$(PREFIX)_hap1_mmapreads.mpileup: $(HetSNV_MMAPALNS_FILENAME)
	...
	--positions $(PGENOME_DIR)/$(VCF_SAMPLE_ID)_hetSNVs_hap1_correct.bed --output $@
...
$(PREFIX)_hap2_mmapreads.mpileup: $(HetSNV_MMAPALNS_FILENAME)
	...
	--positions $(PGENOME_DIR)/$(VCF_SAMPLE_ID)_hetSNVs_hap2_correct.bed --output $@
...
$(PREFIX)_$(ALIGNMENT_MODE)-params_crdsorted_mmapreads_over_hetSNVs.bam: $(FINAL_ALIGNMENT_FILENAME)
	cat $(PGENOME_DIR)/$(VCF_SAMPLE_ID)_hetSNVs_hap1_correct.bed $(PGENOME_DIR)/$(VCF_SAMPLE_ID)_hetSNVs_hap2_correct.bed | \
