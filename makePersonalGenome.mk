...
VCF2DIPLOID_DIR               := /gpfs/gibbs/pi/gerstein/en325/ENTEX2/vcf2diploid
...
## Primary assembly
  ...
  REFGENOME        := /gpfs/gibbs/pi/gerstein/en325/ENTEX2/AlleleSeq2/hg38.analysisSet.fa
...
$(OUTPUT_DIR)/STAR_idx_diploid_Log.out: $(OUTPUT_DIR)/$(VCF_SAMPLE_ID)_diploid.$(notdir $(ANNOTATION)) $(OUTPUT_DIR)/$(VCF_SAMPLE_ID)_hap2.fa $(OUTPUT_DIR)/$(VCF_SAMPLE_ID)_hap1.fa
	...
	$(STAR) \
		...
		--genomeFastaFiles $(OUTPUT_DIR)/$(VCF_SAMPLE_ID)_hap1.fa $(OUTPUT_DIR)/$(VCF_SAMPLE_ID)_hap2.fa \
